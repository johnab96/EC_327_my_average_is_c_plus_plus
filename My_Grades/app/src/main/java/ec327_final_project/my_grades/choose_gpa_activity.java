...
public class choose_gpa_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] gpa_activities = {"Enter Courses", "Display GPAs", "Enter Scores", "Estimate Performance"};
        ...
        main_activities_ListView.setOnItemClickListener(new OnItemClickListener() {
                                                            ...
                                                            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                                                ...
                                                                else if((String.valueOf(adapterView.getItemAtPosition(position)).equals("Estimate Performance"))) {
